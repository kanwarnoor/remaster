...
export default function SongPage(props: Props) {
  ...
  const date = new Date(props.data.album.createdAt);
  ...
  const [formData, setFormData] = useState({
    ...
    artist: props.data.album.artist,
    previewArt: props.data.album.image
      ? `https://remaster-storage.s3.ap-south-1.amazonaws.com/images/track/${props.data.album.image}`
      : null,
      ...
      <div className="h-80 rounded mx-20 mt-10 flex justify-left text-left ">
        ...
        <div className="w-full">
          <div className="w-full h-[65%] text-ellipsis ml-10  justify-center flex flex-col">
            <p className="text-sm font-bold opacity-60">Album</p>
